            ...
            <div class="card-body">
              ...
              <table id="tbl" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-info btn-sm" href="{{url('admin/product/edit/'.$item->id )}}" style="margin-top: 10px"> <i class="fas fa-pencil-alt edit"></i> Edit</a>  <a class="btn btn-info btn-sm" href="{{url("/shop/product-detail/$item->id")}}" style="background:blue;margin-top: 10px"  target="_blank"><i class="fas fa-eye"></i> View</a>
