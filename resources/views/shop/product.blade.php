...
<div id="page-content">
    ...
    <div class="collection-header">
        <div class="collection-hero">
            <div class="collection-hero__image"><img data-src="{{asset('shop-new/assets/images/cat-women3.jpg')}}" src="{{asset('shop-new/assets/images/cat-women3.jpg')}}" alt="Women" title="Women" /></div>
                        ...
                        <div class="list-view-items grid--view-items">
                            ...
                            <div class="list-product list-view-item">
                                ...
                                <div class="list-view-item__title-column">
                                    ...
                                    <!-- End Price -->
                                    <form class="variants" action="{{url('shop/product-detail/' .$item->id)}}">
                                        @csrf
