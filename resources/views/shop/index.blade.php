        ...
        <div class="home-slideshow">
            <div class="slide">
                <div class="blur-up lazyload">
                    <img class="blur-up lazyload" data-src="{{asset('image/shop-slider/home.jpg')}}" src="{{asset('image/shop-slider/home.jpg')}}" alt="Shop Our New Collection" title="Shop Our New Collection" />
