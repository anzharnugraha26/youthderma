...
<html lang="en">
  <head>
    ...
    <title>YOUTHDERMA AESTHETIC Online Store</title>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="{{asset('shop-master/css/bootstrap.min.css')}}">
    
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{asset('shop-master/css/font-awesome.min.css')}}">
    
    <!-- Custom CSS -->
    <link rel="stylesheet" href="{{asset('shop-master/css/owl.carousel.css')}}">
    <link rel="stylesheet" href="{{asset('shop-master/style.css')}}">
    <link rel="stylesheet" href="{{asset('shop-master/css/responsive.css')}}">
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="./"><img src="{{asset('image/logo/logo.png')}}" height="33px" width="200px"></a></h1>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="shop.html">Chart</a></li>
